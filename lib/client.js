...
`
    ...
    function apply(ctx) {
      ...
      // Cindy 专属 Logo：品牌渐变圆角底 + 白色「待办清单+对勾」徽记
      const CindyLogo = React.memo(function CindyLogo({ size = 20 }) {
        ...
        return h('svg', { width: size, height: size, viewBox: '0 0 24 24', style: { display: 'block', flex: 'none' } },
          ...
          h('path', { d: 'M9.2 4.6H7.4a1.8 1.8 0 0 0-1.8 1.8v12a1.8 1.8 0 0 0 1.8 1.8h9.2a1.8 1.8 0 0 0 1.8-1.8V6.4a1.8 1.8 0 0 0-1.8-1.8h-1.8', fill: 'none', stroke: '#fff', strokeWidth: '1.9', strokeLinecap: 'round', strokeLinejoin: 'round' }),
          h('path', { d: 'M9.2 4.6a1.9 1.9 0 0 1 1.9-1.9h1.8a1.9 1.9 0 0 1 1.9 1.9', fill: 'none', stroke: '#fff', strokeWidth: '1.9', strokeLinecap: 'round', strokeLinejoin: 'round' }),
          h('path', { d: 'm8.8 12.6 2.2 2.2 4.2-4.4', fill: 'none', stroke: '#fff', strokeWidth: '1.9', strokeLinecap: 'round', strokeLinejoin: 'round' }))
      })
